...
This is a sample template for sam-uploader - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sam-uploader --query 'Stacks[].Outputs'
```
